  ...
  const footerSections = [
    ...
    },
    {
      ...
      links: [
        ...
        { name: 'Retail & Education', href: '/projects?sector=retail' }
      ]
    },
    {
      title: 'Company',
  ...
  return (
    <>
      ...
      <footer className="relative bg-black text-white overflow-hidden" style={{ fontFamily: "'Archivo', sans-serif" }}>
        ...
        {/* Red Gradient Accent */}
        <div className="absolute top-0 left-0 right-0 h-[2px] bg-gradient-to-r from-transparent via-red-600 to-transparent"></div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-6 gap-8 lg:gap-8 mb-12">
            ...
            <div className="lg:col-span-2">
              ...
              <p className="text-gray-400 text-sm leading-relaxed mb-6">
                Leading project development consultancy delivering excellence across the UAE and MENA region.
              </p>
              ...
              <div className="space-y-3 text-sm text-gray-400 mb-6">
                <div className="flex items-start gap-3">
                  ...
                  <span>Office 2606, Churchill Tower,<br />Burj Khalifa District, Business Bay<br />Dubai, U.A.E | P.O.Box: 450302</span>
                </div>
                <div className="flex items-center gap-3">
                  <svg className="w-5 h-5 text-red-600 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                  </svg>
                  <span>+971 4 277 5734 / 0399</span>
                </div>
                <div className="flex items-center gap-3">
                  <svg className="w-5 h-5 text-red-600 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                  </svg>
                  <a href="mailto:info@pdcconsult.com" className="hover:text-red-600 transition-colors">info@pdcconsult.com</a>
                </div>
                <div className="flex items-center gap-3">
                  <svg className="w-5 h-5 text-red-600 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9a9 9 0 01-9-9m9 9c1.657 0 3-4.03 3-9s-1.343-9-3-9m0 18c-1.657 0-3-4.03-3-9s1.343-9 3-9m-9 9a9 9 0 019-9" />
                  </svg>
                  <a href="https://www.pdcconsult.com" target="_blank" rel="noopener noreferrer" className="hover:text-red-600 transition-colors">www.pdcconsult.com</a>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4">
                {socialLinks.map((social, index) => (
                  <a
                    ...
                    className="w-10 h-10 flex items-center justify-center bg-white/5 border border-white/10 hover:bg-red-600 hover:border-red-600 text-gray-400 hover:text-white transition-all duration-300"
                  >
                    {social.icon}
                  </a>
                ))}
          ...
          <div className="border-t border-white/10 pt-8">
            <div className="flex flex-col md:flex-row justify-between items-center gap-4">
              ...
              <div className="text-gray-500 text-sm text-center md:text-left">
                © {currentYear} PDC Consult. All rights reserved.
              </div>

              {/* Legal Links */}
              <div className="flex flex-wrap items-center justify-center gap-6 text-sm">
                <Link href="/privacy" className="text-gray-400 hover:text-red-600 transition-colors duration-300">
                  Privacy Policy
                </Link>
                <Link href="/terms" className="text-gray-400 hover:text-red-600 transition-colors duration-300">
                  Terms of Service
                </Link>
              </div>
